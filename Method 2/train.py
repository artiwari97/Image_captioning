...
writer = SummaryWriter(log_dir="tensorboard-2/")
...
def train(train_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch):
    ...
    for i, (imgs, caps, caplens) in enumerate(train_loader):
        ...
        #write to tensorboard
        writer.add_scalar('training_loss_per_batch_update', losses.val, epoch*len(train_loader)+i)
        writer.add_scalar('training_accuracy_per_batch_update', top5accs.val, epoch*len(train_loader)+i)
    ...
    #write to tensorboard
    writer.add_scalar('avg_training_loss_per_epoch', losses.avg, epoch)
    writer.add_scalar('avg_training_accuracy_per_epoch', top5accs.avg, epoch)
